...
class Script
{
    static public void Main(string[] args)
    {
        var project = new Project("Setup",
                new ElevatedManagedAction(@"RegisterFileType", Return.ignore, When.After, Step.InstallInitialize, Condition.NOT_BeingRemoved),
                new ElevatedManagedAction(@"UnRegisterFileType", Return.ignore, When.After, Step.InstallInitialize, Condition.Installed));
